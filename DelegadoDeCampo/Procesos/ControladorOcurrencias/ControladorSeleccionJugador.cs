...
namespace DelegadoDeCampo.Procesos.ControladorOcurrencias
{
    ...
    class ControladorSeleccionJugador : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            int id = ReporteOcurrencia.Instancia.ObtenerIdEquipo();
            if (id != int.MinValue)
            {
            ...
            string nombre = ReporteOcurrencia.Instancia.ObtenerUltimoNombreEquipoAlmacenado();
